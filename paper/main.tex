...
D-reducible pool to its $5{,}895$ members of ring size $\le 14$, we prove that
\emph{no} nonnegative amount vector $x\in\mathbb{R}^{84}_{\ge 0}$ closes the
discharging argument. The proof is a $12$-row irreducible Farkas certificate,
...
framing is Tao's and Buzzard's \cite{tao2023machine,buzzard2024}: a machine proof
...
rather than merely correct --- is articulated by Tao \cite{tao2023machine} and
...
amounts $x \in \mathbb{R}^{84}_{\ge 0}$ under which the discharging argument closes
over $P_{14}$: i.e.\ under which every vertex of a hypothetical minimum
...
$(\log_2\beta - 1)/(1 - \log_2\gamma)$. \emph{The entire source of $f$-growth is the
